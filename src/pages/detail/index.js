...
const Detail = () => {
    ...
    return (
        <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} sx={{height:"85vh", my:5}}>
                <Rating
                ...
                <Button variant="contained" size="small">{constant.BUTTONS.ADD_TO_BASKET}</Button>
                <Typography variant="subtitle1">
                {constant.SHOP_INFO.TEL.LABLE} : {constant.SHOP_INFO.TEL.CONTENT}
                <br/>
                {constant.SHOP_INFO.PHONE_NUMBER.LABLE} : {constant.SHOP_INFO.PHONE_NUMBER.CONTENT}
                <br/>
                {constant.SHOP_INFO.ADDRESS.LABLE} : {constant.SHOP_INFO.ADDRESS.CONTENT}
                <br/>
            ...
            <Grid item xs={12} sm={6} >
                ...
                Large Persian motifs call attention to the brilliant,<br/> earth-tone hues and vibrant blue highlights that fill the soft,<br/> ornate pile. The ideal floor coverings to accentuate living room or<br/> dining room decor.
                </Typography>
                <Typography variant="subtitle1">
                    Size: 4’9 X 6'8<br/>
